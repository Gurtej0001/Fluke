...
class NewCreateNewDialogVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "UserCellConstant", bundle: nil), forCellReuseIdentifier: "UserCellConstant")
        ...
        let backButtonItem = UIBarButtonItem(image: UIImage(named: "iconClose"),
                                             style: .plain,
                                             target: self,
...
extension NewCreateNewDialogVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "UserCellConstant",
