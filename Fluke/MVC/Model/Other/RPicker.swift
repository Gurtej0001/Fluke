...
class RPickerController: UIViewController {
    ...
    private let buttonColor = #colorLiteral(red: 0.937254902, green: 0.2431372549, blue: 0.568627451, alpha: 1)
    private let lineColor = #colorLiteral(red: 0.05882352963, green: 0.180392161, blue: 0.2470588237, alpha: 1)
    ...
    private lazy var doneButton: UIButton = {
        ...
        button.titleLabel?.font = UIFont(name: "Poppins-Regular", size: 17.0)
...
private extension UIWindow {
    ...
    func topViewController(controller: UIViewController? = appDelegate.window!.rootViewController) -> UIViewController? {
